...
FROMPUBKEY=arkeopub1addwnpepq2tjwwcpqwswatymx7uw3q75sqhljmp0qw3pz2fvnavkv7k2jvknq9k9lr0
USER=adam
arkeod tx arkeo open-contract -y --from $USER --node "tcp://seed.arkeo.network:26657" -- arkeopub1addwnpepqtrc0rrpkwn2esula68zl3dvqqfxfjhr5dyfxy3uq97dssntrq8twhy9nvu btc-mainnet-fullnode "$FROMPUBKEY" "$CTYPE" "$DEPOSIT" "$DURATION" $RATE
